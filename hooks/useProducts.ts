...
function createDataHook<T>(fetchService: () => Promise<T[]>, createService: (data: any) => Promise<T>, updateService: (id: string, data: any) => Promise<T>, deleteService: (id: string) => Promise<T>) {
  return () => {
